 ...
 implements Biblioteca.GestionBibliotecaOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("agregarLibro", new java.lang.Integer (3));
    _methods.put ("eliminarLibro", new java.lang.Integer (4));
    _methods.put ("buscarPorAutor", new java.lang.Integer (5));
    _methods.put ("listarLibros", new java.lang.Integer (6));
  }
  ...
  // Agrega un libro, cambiando su estado a disponible
       case 3:  // Biblioteca/GestionBiblioteca/agregarLibro
       {
         Biblioteca.Libro nuevoLibro = Biblioteca.LibroHelper.read (in);
         boolean $result = false;
         $result = this.agregarLibro (nuevoLibro);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }
  ...
  // Elimina un libro
       case 4:  // Biblioteca/GestionBiblioteca/eliminarLibro
       {
         String ISBN = in.read_string ();
         boolean $result = false;
  ...
  //Listar todos los libros
       case 6:  // Biblioteca/GestionBiblioteca/listarLibros
       {
         Biblioteca.Libro $result[] = null;
